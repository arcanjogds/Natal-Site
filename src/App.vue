<template>
  <div class="container" style="text-align: center; font-family: sans-serif; padding: 2rem; max-width: 600px; margin: auto;">
    ...
    <!-- ========================================== -->
    <!-- ABA 3: VITRINE DE PRESENTES -->
    <!-- ========================================== -->
    <div v-if="activeTab === 'presentes'">
      <Presentes /> <!-- <-- MUDE APENAS ISSO AQUI -->
    </div>
...
import Ceia from './components/Ceia.vue'; // <-- Importando o nosso novo componente!
import Presentes from './components/Presentes.vue'; // <-- ADICIONE ESTA LINHA

// Controle de Abas
const activeTab = ref('sorteio');

// Estilos dos botões do menu
const activeStyle = 'background: #c62828; color: white; border: none; padding: 10px 15px; border-radius: 20px; font-weight: bold; cursor: pointer;';
const inactiveStyle = 'background: #e0e0e0; color: #333; border: none; padding: 10px 15px; border-radius: 20px; font-weight: bold; cursor: pointer;';
